...
import (
	...
	. "github.com/Intrising/radius/rfc2865"
)
...
Included in this package is the command line program `radius-dict-gen`. It can be installed with:
    ...
    go get -u github.com/Intrising/radius/cmd/radius-dict-gen
...
Included in this repository are sub-packages of generated helpers for commonly used RADIUS attributes, including [`rfc2865`](https://godoc.org/github.com/Intrising/radius/rfc2865) and [`rfc2866`](https://godoc.org/github.com/Intrising/radius/rfc2866).
